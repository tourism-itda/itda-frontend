    ...
    >
      <div className="relative aspect-[470/323] lg:aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute left-3 bottom-3 flex items-center gap-1.5">
          ...
          <span className="px-2.5 py-1 rounded-full bg-white/85 backdrop-blur-sm text-neutral-900 text-[11px] font-bold tracking-wide">
            {item.location}
          </span>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8">
        ...
        <section className="pt-10 lg:pt-16 pb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="flex-1 min-w-0">
              <p className="text-[11px] tracking-[0.2em] text-primary font-bold uppercase mb-3">Discover Korean History</p>
        ...
        <section className="mb-20">
          <div className="flex items-end justify-between mb-6">
            <div>
              <p className="text-[11px] tracking-[0.2em] text-primary font-bold uppercase mb-2">
