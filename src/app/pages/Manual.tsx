...
const steps = [
  {
    icon: Compass,
    title: "1. 콘텐츠 탐색하기",
    body: "홈 화면에서 좋아하는 영화를 검색하거나 '콘텐츠 둘러보기'에서 골라보세요. 각 콘텐츠 상세 페이지에서 실제 촬영지와 배경이 된 역사 유적지를 확인할 수 있습니다.",
  },
  {
    icon: MapPinned,
    title: "2. 여행 코스 확인하기",
    body: "콘텐츠와 연결된 추천 코스를 열람하면 방문 순서, 주소, 운영시간 등 상세 정보를 볼 수 있습니다. 지도 앱 연동을 통해 바로 길찾기도 가능합니다.",
  },
  {
    icon: CalendarCheck,
    title: "3. 플래너에 저장하기",
    body: "마음에 드는 코스는 '가져오기' 버튼으로 내 플래너에 저장하세요. 하단 내비게이션의 플래너 탭에서 저장한 일정을 언제든 다시 확인할 수 있습니다.",
  },
  {
    icon: Users,
    title: "4. 커뮤니티 이용하기",
